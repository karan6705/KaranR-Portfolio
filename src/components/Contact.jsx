...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_0du3w8ka',      // Your Service ID
        'template_4z776ml',      // Your Template ID
        {
          from_name: form.name,
          to_name: 'Karan Raval',               // Your name
          from_email: form.email,
          to_email: 'karanraval3409@gmail.com', // Your email
          message: form.message,
        },
        '3GSPABt14LezxrBiW'      // Your Public Key
      )
      .then(
        () => {
          setLoading(false);
